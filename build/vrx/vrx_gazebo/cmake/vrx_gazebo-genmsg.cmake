...
set(MSG_I_FLAGS "-Ivrx_gazebo:/home/brad/vrx_amore/src/vrx/vrx_gazebo/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/brad/vrx_amore/src/vrx/vrx_gazebo/msg/Task.msg" NAME_WE)
add_custom_target(_vrx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vrx_gazebo" "/home/brad/vrx_amore/src/vrx/vrx_gazebo/msg/Task.msg" ""
)

get_filename_component(_filename "/home/brad/vrx_amore/src/vrx/vrx_gazebo/msg/Contact.msg" NAME_WE)
add_custom_target(_vrx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vrx_gazebo" "/home/brad/vrx_amore/src/vrx/vrx_gazebo/msg/Contact.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/brad/vrx_amore/src/vrx/vrx_gazebo/srv/ColorSequence.srv" NAME_WE)
add_custom_target(_vrx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vrx_gazebo" "/home/brad/vrx_amore/src/vrx/vrx_gazebo/srv/ColorSequence.srv" ""
)

get_filename_component(_filename "/home/brad/vrx_amore/src/vrx/vrx_gazebo/srv/BallShooter.srv" NAME_WE)
add_custom_target(_vrx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "vrx_gazebo" "/home/brad/vrx_amore/src/vrx/vrx_gazebo/srv/BallShooter.srv" ""
)
