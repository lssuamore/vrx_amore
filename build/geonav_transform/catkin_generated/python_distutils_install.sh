...
echo_and_run cd "/home/shaede/vrx_amore/src/geonav_transform"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/shaede/vrx_amore/src/geonav_transform/setup.py" \
     \
    build --build-base "/home/shaede/vrx_amore/build/geonav_transform" \
    install \
    --root="${DESTDIR-/}" \
