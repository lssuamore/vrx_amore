...
bool mission_control_initialized = false;
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber na_initialization_state_sub = nh3.subscribe("na_initialization_state", 1, NAVIGATION_ARRAY_inspector);								// initialization status of navigation_array
  ros::Subscriber pp_initialization_state_sub = nh4.subscribe("pp_initialization_state", 1, PATH_PLANNER_inspector);										// initialization status of path_planner
  ros::Subscriber ps_initialization_state_sub = nh5.subscribe("ps_initialization_state", 1, PROPULSION_SYSTEM_inspector);							// initialization status of propulsion_system
  ros::Subscriber pa_initialization_state_sub = nh6.subscribe("pa_initialization_state", 1, PERCEPTION_ARRAY_inspector);								// initialization status of perception_array
